...
- 写 `.journal.md` 的 [in_progress] / [done]
- 跑 Mini-Check（详见 SKILL.md 第十五节）
...
| 操作 | 检查 |
|---|---|
| Capture 到 active.md | id 全局唯一；引用的 project 是否存在；动词前置改写完成；active.md 顶部 total/by_project_count 已重算；INDEX 已刷新 |
